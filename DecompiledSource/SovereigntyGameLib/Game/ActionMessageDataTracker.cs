	...
	internal class ActionMessageDataTracker
	{
		...
		public void ShowMessages()
		{
			...
			foreach (Tuple<WorkingRealm, WorkingRealm> tuple2 in this.DestroyedRealms)
			{
				...
				if (tuple2.Item1.DiplomacyManager.IgnoreDestroyPenalties.Contains(tuple2.Item2.Name))
				{
					messageBoxData3.MessageText = GameText.CreateLocalised("REALMMSGTEXTB", new object[0]);
				}
				else
				{
					messageBoxData3.MessageText = GameText.CreateLocalised("REALMMSGTEXT", new object[0]);
				}
				messageBoxData3.MessageText.AddChildText(GameText.CreateLocalised(tuple2.Item1.DisplayName, new object[0]));
				messageBoxData3.MessageText.AddChildText(GameText.CreateLocalised(tuple2.Item2.DisplayName, new object[0]));
