...
{
	public class AITacActionHeal : AITacAction
	{
		public AITacActionHeal(AIActionManager Manager, SovereigntyGame Game, TacticalBattleController Battle)
		...
		{
			this.Battle.RequestAttackUnit(this.Unit, this.TargetUnit, this.UnitActions, CombatAction.Heal);
